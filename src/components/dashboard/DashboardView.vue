  ...
  <div class="space-y-6">
    ...
    <div class="bg-linear-to-bl from-secondary to-fuchsia-500 rounded-lg shadow-lg text-white p-6">
      <div class="flex items-center justify-between">
        ...
        <div class="w-16 h-16 bg-secondary-content bg-opacity-20 rounded-full flex items-center justify-center">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
      <div class="bg-neutral rounded-lg shadow p-4 border-l-4 border-white">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-neutral-content">Tipo de Usuario</p>
            <p class="text-lg font-semibold text-neutral-content capitalize">{{ user.tipo }}</p>
          </div>
      ...
      <div class="bg-neutral rounded-lg shadow p-4 border-l-4 border-green-500">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-neutral-content">Sesión Activa</p>
            <p class="text-lg font-semibold text-neutral-content">Conectado</p>
          </div>
      ...
      <div class="bg-neutral rounded-lg shadow p-4 border-l-4 border-purple-500">
        <div class="flex items-center justify-between">
          <div>
            <p class="text-sm text-neutral-content">Email Verificado</p>
            <p class="text-lg font-semibold text-neutral-content">{{ user.email }}</p>
          </div>
    ...
    <div class="bg-neutral rounded-lg shadow p-6">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        >
          ...
          <h3 class="font-semibold text-neutral-content mb-1">Gestión de Usuarios</h3>
          <p class="text-sm text-neutral-content">Administrar usuarios del sistema</p>
        </button>
        ...
        >
          ...
          <h3 class="font-semibold text-neutral-content mb-1">Catálogo de Libros</h3>
          <p class="text-sm text-neutral-content">Explorar y gestionar libros</p>
        </button>
        ...
        >
          ...
          <h3 class="font-semibold text-neutral-content mb-1">Préstamos</h3>
          <p class="text-sm text-neutral-content">Gestionar préstamos de libros</p>
        </button>
      </div>
    </div>
